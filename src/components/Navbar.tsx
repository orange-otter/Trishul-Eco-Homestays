...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-white/20 dark:border-white/5 shadow-sm transition-colors duration-300">
          ...
          <div className="pt-4 border-t border-border dark:border-gray-800 flex flex-col gap-4">
            {user ? (
              <>
                ...
                <Link to="/profile" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 font-semibold text-text-secondary dark:text-gray-400">
