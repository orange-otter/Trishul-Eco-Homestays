...
export default function Profile() {
  ...
  return (
    <div className="min-h-[70vh] py-16 px-6 max-w-[1000px] mx-auto animate-in fade-in duration-700">
      <h1 className="text-3xl font-bold font-serif text-primary-hover dark:text-primary-light mb-8">My Profile</h1>
      
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Account Info Sidebar */}
        <div className="lg:col-span-1 h-fit bg-surface dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-border dark:border-gray-800">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-2xl font-bold font-serif text-primary-hover dark:text-primary-light mb-6">My Trips</h2>
          {isLoading ? (
